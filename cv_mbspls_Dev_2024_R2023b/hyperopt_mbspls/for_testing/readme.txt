...
================================
-hyperopt_mbspls 
-run_hyperopt_mbspls.sh (shell script for temporarily setting environment variables and 
                         executing the application)
   -to run the shell script, type
   
       ./run_hyperopt_mbspls.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2023b, run the shell script as:
       ...
       ./run_hyperopt_mbspls.sh /mathworks/home/application/R2023b
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_hyperopt_mbspls.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/R2023b/runtime/glnxa64:MR/R2023b/bin/glnxa64:MR/R2023b/sys/os/glnxa64:MR/R2023b/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_hyperopt_mbspls.sh 
